...
{ return TEST_FLAG(identifier, _player_start_doesnt_auto_recenter_flag) != 0; }

inline bool player_start_doesnt_auto_recenter(const player_start_data * const p)
{ return TEST_FLAG(p->identifier, _player_start_doesnt_auto_recenter_flag) != 0; }
...
{ return TEST_FLAG(identifier, _player_start_doesnt_auto_switch_weapons_flag) != 0; }

inline bool player_start_doesnt_auto_switch_Weapons(const player_start_data * const p)
{ return TEST_FLAG(p->identifier, _player_start_doesnt_auto_switch_weapons_flag) != 0; }
