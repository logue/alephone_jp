/////////////////////////////////////////////////////////////////////////
// $Id: AStream.h,v 1.1 2007-01-31 10:20:35 hogepiyo Exp $
/////////////////////////////////////////////////////////////////////////
...
namespace AStream
{
	...
	protected:
		...
		uint32
		tell_pos() const
		{ return static_cast<uint32>(_M_stream_pos - _M_stream_begin); } 

		uint32
		max_pos() const
		{ return static_cast<uint32>(_M_stream_end - _M_stream_begin); }
