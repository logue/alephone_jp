...
char* fon[] = {
"12,0,0,0,400,0,0,0,0,1,2,1,34,MS Sans Serif",
"10,0,0,0,400,0,0,0,0,1,2,1,34,MS Sans Serif",
...
class _init_app_class_{
  public: _init_app_class_(){
    ...
    app->setInstanceName("PhysicsEditorWS");
  };
};
static _init_app_class_ _execute_app_class_;

//--- OBJECT execute auto initialize ---//
extern WSDLEX WSCbase* _create_win_MainWindow();
class _initialize_window_0{
 public: _initialize_window_0(){
  WSGIappDev()->setInitHandler((void(*)())_create_win_MainWindow);
 };
};
