	...
	short garbage_object_index)
{
	...
	if (garbage_objects_in_polygon> (MAXIMUM_GARBAGE_OBJECTS_PER_POLYGON * 2))
	{
	...
	else
	{
	  ...
	  if (dynamic_world->garbage_object_count>= (MAXIMUM_GARBAGE_OBJECTS_PER_MAP * 2))
	    {
