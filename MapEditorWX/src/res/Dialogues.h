...
class JumpLevelDialog: public wxDialog {
public:
    // begin wxGlade: JumpLevelDialog::ids
    // end wxGlade

    JumpLevelDialog(wxWindow* parent, int id, const wxString& title, const wxPoint& pos=wxDefaultPosition, const wxSize& size=wxDefaultSize, long style=wxDEFAULT_DIALOG_STYLE);

private:
    // begin wxGlade: JumpLevelDialog::methods
    void set_properties();
    void do_layout();
    // end wxGlade

protected:
    // begin wxGlade: JumpLevelDialog::attributes
