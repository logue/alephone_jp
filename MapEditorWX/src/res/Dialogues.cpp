// -*- C++ -*- generated by wxGlade 0.5 on Sun Jun 24 17:32:57 2007 from C:\(0saved\marathon\MapEditorWX\src\res\MapEditorWX.wxg
...
JumpLevelDialog::JumpLevelDialog(wxWindow* parent, int id, const wxString& title, const wxPoint& pos, const wxSize& size, long style):
    wxDialog(parent, id, title, pos, size, wxDEFAULT_DIALOG_STYLE)
{
    // begin wxGlade: JumpLevelDialog::JumpLevelDialog
...
BEGIN_EVENT_TABLE(JumpLevelDialog, wxDialog)
    // begin wxGlade: JumpLevelDialog::event_table
    EVT_LISTBOX(wxID_ANY, JumpLevelDialog::OnList)
    EVT_BUTTON(wxID_OK, JumpLevelDialog::OnOk)
    EVT_BUTTON(wxID_CANCEL, JumpLevelDialog::OnCancel)
    // end wxGlade
END_EVENT_TABLE();


void JumpLevelDialog::OnList(wxCommandEvent &event)
{
    event.Skip();
    std::cout<<"Event handler (JumpLevelDialog::OnList) not implemented yet"<<std::endl; //notify the user that he hasn't implemented the event handler yet
}


void JumpLevelDialog::OnOk(wxCommandEvent &event)
{
    event.Skip();
    std::cout<<"Event handler (JumpLevelDialog::OnOk) not implemented yet"<<std::endl; //notify the user that he hasn't implemented the event handler yet
}


void JumpLevelDialog::OnCancel(wxCommandEvent &event)
{
    event.Skip();
    std::cout<<"Event handler (JumpLevelDialog::OnCancel) not implemented yet"<<std::endl; //notify the user that he hasn't implemented the event handler yet
}


// wxGlade: add JumpLevelDialog event handlers


void JumpLevelDialog::set_properties()
{
    // begin wxGlade: JumpLevelDialog::set_properties
...
void JumpLevelDialog::do_layout()
{
    // begin wxGlade: JumpLevelDialog::do_layout
