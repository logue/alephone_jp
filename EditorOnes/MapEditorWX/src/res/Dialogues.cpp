// -*- C++ -*- generated by wxGlade 0.5 on Fri Aug 10 17:49:21 2007 from C:\0save\marathon\EditorOnes\MapEditorWX\src\res\MapEditorWX.wxg
    ...
    wxDialog(parent, id, title, pos, size, wxDEFAULT_DIALOG_STYLE)
{
    ...
    button_34 = new wxButton(this, wxID_ANY, wxT("button_34"));
    button_37 = new wxButton(this, wxID_ANY, wxT("button_37"));
...
void PointPropDialog::do_layout()
{
    ...
    wxFlexGridSizer* grid_sizer_46 = new wxFlexGridSizer(1, 2, 0, 0);
    ...
    grid_sizer_46->Add(button_34, 0, 0, 0);
    grid_sizer_46->Add(button_37, 0, 0, 0);
    grid_sizer_10->Add(grid_sizer_46, 1, wxEXPAND, 0);
    ...
    wxDialog(parent, id, title, pos, size, wxDEFAULT_DIALOG_STYLE)
{
    ...
    label_77 = new wxStaticText(this, wxID_ANY, wxT("Floor height"));
    text_ctrl_48 = new wxTextCtrl(this, wxID_ANY, wxEmptyString);
    label_78 = new wxStaticText(this, wxID_ANY, wxT("Ceiling height"));
    text_ctrl_49 = new wxTextCtrl(this, wxID_ANY, wxEmptyString);
...
void PolygonPropDialog::do_layout()
{
    ...
    grid_sizer_13->Add(label_77, 0, 0, 0);
    grid_sizer_13->Add(text_ctrl_48, 0, 0, 0);
    grid_sizer_13->Add(label_78, 0, 0, 0);
    grid_sizer_13->Add(text_ctrl_49, 0, 0, 0);
    ...
    wxDialog(parent, id, title, pos, size, wxDEFAULT_DIALOG_STYLE)
{
    ...
    radio_box_2 = new wxRadioBox(this, wxID_ANY, wxT("radio_box_2"), wxDefaultPosition, wxDefaultSize, 8, radio_box_2_choices, 0, wxRA_SPECIFY_ROWS);
    ...
    wxDialog(parent, id, title, pos, size, wxDEFAULT_DIALOG_STYLE)
{
    ...
    sizer_57_copy_staticbox = new wxStaticBox(this, -1, wxT("Primary texture"));
    sizer_57_copy_1_staticbox = new wxStaticBox(this, -1, wxT("Primary texture"));
    ...
    bitmap_button_7 = new wxBitmapButton(this, wxID_ANY, wxNullBitmap);
    ...
    label_79 = new wxStaticText(this, wxID_ANY, wxT("x"));
    text_ctrl_54 = new wxTextCtrl(this, wxID_ANY, wxEmptyString);
    label_103 = new wxStaticText(this, wxID_ANY, wxT("y"));
    text_ctrl_56 = new wxTextCtrl(this, wxID_ANY, wxEmptyString);
    bitmap_button_7_copy = new wxBitmapButton(this, wxID_ANY, wxNullBitmap);
    ...
    const wxString choice_24_copy_choices[] = {
        
    };
    choice_24_copy = new wxChoice(this, wxID_ANY, wxDefaultPosition, wxDefaultSize, 0, choice_24_copy_choices, 0);
    ...
    bitmap_button_7_copy_1 = new wxBitmapButton(this, wxID_ANY, wxNullBitmap);
    ...
    const wxString choice_24_copy_1_choices[] = {
        
    };
    choice_24_copy_1 = new wxChoice(this, wxID_ANY, wxDefaultPosition, wxDefaultSize, 0, choice_24_copy_1_choices, 0);
...
void SidePropDialog::do_layout()
{
    ...
    wxFlexGridSizer* grid_sizer_66 = new wxFlexGridSizer(1, 2, 0, 0);
    wxFlexGridSizer* grid_sizer_67 = new wxFlexGridSizer(2, 2, 0, 0);
    ...
    grid_sizer_60->Add(bitmap_button_7, 0, 0, 0);
    ...
    grid_sizer_67->Add(label_79, 0, 0, 0);
    grid_sizer_67->Add(text_ctrl_54, 0, 0, 0);
    grid_sizer_67->Add(label_103, 0, 0, 0);
    grid_sizer_67->Add(text_ctrl_56, 0, 0, 0);
    grid_sizer_66->Add(grid_sizer_67, 1, wxEXPAND, 0);
    grid_sizer_66->Add(bitmap_button_7_copy, 0, 0, 0);
    sizer_57_copy->Add(grid_sizer_66, 1, wxEXPAND, 0);
    ...
    grid_sizer_60_copy_1->Add(bitmap_button_7_copy_1, 0, 0, 0);
    ...
    wxDialog(parent, id, title, pos, size, wxDEFAULT_DIALOG_STYLE)
{
    ...
    label_76 = new wxStaticText(this, wxID_ANY, wxT("Collection"));
...
{
    event.Skip();
    std::cout<<"Event handler (TextureDialog::OnCollection) not implemented yet"<<std::endl; //notify the user that he hasn't implemented the event handler yet
}
...
void TextureDialog::do_layout()
{
    ...
    wxFlexGridSizer* grid_sizer_45 = new wxFlexGridSizer(1, 5, 0, 0);
    grid_sizer_45->Add(label_75, 0, 0, 0);
    grid_sizer_45->Add(choice_30, 0, 0, 0);
    grid_sizer_45->Add(20, 20, 0, 0, 0);
    grid_sizer_45->Add(label_76, 0, 0, 0);
    grid_sizer_45->Add(choice_31, 0, 0, 0);
...
TextureSelectDialog::TextureSelectDialog(wxWindow* parent, int id, const wxString& title, const wxPoint& pos, const wxSize& size, long style):
    wxDialog(parent, id, title, pos, size, wxDEFAULT_DIALOG_STYLE)
{
    // begin wxGlade: TextureSelectDialog::TextureSelectDialog
...
void TextureSelectDialog::set_properties()
{
    // begin wxGlade: TextureSelectDialog::set_properties
    SetTitle(wxT("dialog_20"));
    // end wxGlade
}


void TextureSelectDialog::do_layout()
{
    // begin wxGlade: TextureSelectDialog::do_layout
    Layout();
    // end wxGlade
}
