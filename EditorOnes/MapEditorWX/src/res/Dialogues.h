...
public:
    // begin wxGlade: TextureSelectDialog::ids
    // end wxGlade

    TextureSelectDialog(wxWindow* parent, int id, const wxString& title, const wxPoint& pos=wxDefaultPosition, const wxSize& size=wxDefaultSize, long style=wxDEFAULT_DIALOG_STYLE);

private:
    // begin wxGlade: TextureSelectDialog::methods
    void set_properties();
    void do_layout();
    // end wxGlade

protected:
    // begin wxGlade: TextureSelectDialog::attributes
    // end wxGlade
}; // wxGlade: end class
