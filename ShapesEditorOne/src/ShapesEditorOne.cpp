// ShapesEditorOne.cpp : Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(CShapesEditorOneApp, CWinApp)
...
CShapesEditorOneApp::CShapesEditorOneApp()
{
...
// The one and only CShapesEditorOneApp object

CShapesEditorOneApp theApp;


// CShapesEditorOneApp initialization

BOOL CShapesEditorOneApp::InitInstance()
{
